"""
Django settings for cold_shape_dev_68463 project.
...
ROOT_URLCONF = 'cold_shape_dev_68463.urls'
...
WSGI_APPLICATION = 'cold_shape_dev_68463.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_shape_dev_68463 API",
    "DESCRIPTION": "API documentation for cold_shape_dev_68463 App",
    "VERSION": "v1",
}
